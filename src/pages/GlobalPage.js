...
import networkLogo from '../assets/polygon.jpg'
          ...
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            ...
            >
              <Network>
                ...
                <NetworkName>Polygon (Matic)</NetworkName>
              </Network>
          ...
          <ListOptions gap="10px" style={{ marginTop: '2rem', marginBottom: '.5rem' }}>
            <RowBetween>
              ...
              <AutoRow gap="4px" width="100%" justifyContent="flex-end">
                ...
                />
                <QuestionHelper text="USD amounts may be inaccurate in low liquiidty pairs or pairs without MATIC or stablecoins." />
